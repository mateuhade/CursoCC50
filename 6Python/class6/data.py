...
# We also have *Dicts*. Short for dictionaries, dicts lets you connect two values, like a
# dictionary for spanish that has the spanish word and its translation, a phonebook which
# has a name and its number respectiove to the name. Ex: {"Brian": "+1-617-495-1000"}, here
# we have the key "Brian", which refers to the number string. REFER TO NOTE 6
